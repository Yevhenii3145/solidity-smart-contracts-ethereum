...
contract Demo {
    ...
    function pay() external payable {
        balance += msg.value; // если средства пришли они автоматически зачислятся на баланс (можно ничего не писать в функции)
    }
    ...
    // call - вызов за который не нужно платить, используется чтобы считать какие-то данные, либо сделать вычисления с данными из инпутаб но нельзя данные в блокчейне модифицировать
